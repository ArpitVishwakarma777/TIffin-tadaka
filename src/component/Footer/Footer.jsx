...
import { FaFacebookF,FaGithub ,FaLinkedin  ,FaTwitter,FaGoogle,FaInstagram  } from "react-icons/fa";
    ...
    <div className="container text-center text-md-start mt-5">
      <div className="row mt-3">
        ...
        <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
          <h5 className=" main-teaxt text-uppercase fw-bold fs-4 mb-4">Products</h5>
          <p>
        ...
        <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
          ...
          <pre>
              ...
              <span style={{fontSize:'18px'}}>  info@example.com</span>
          </pre>
          <p>
